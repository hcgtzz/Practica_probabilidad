...
resolver_ejercicios_1_al_18 <- function() {
  ...
  # --- Ejercicio 16: Hipergeométrica (Componentes electrónicos) --- Listo
  # EJERCICIO 16 - DISTRIBUCION HIPERGEOMETRICA
...
ggsave(
  ...
  # --- Ejercicio 17: Geométrica (Tiro libre) --- Listo

  # EJERCICIO 17 - DISTRIBUCION GEOMETRICA
...
ggsave(
  ...
  # --- Ejercicio 18: Binomial Negativa (Inspector de calidad) --- Listo
  # EJERCICIO 18 - DISTRIBUCION BINOMIAL NEGATIVA
